...
<div class="container">
    ...
    <div class="form-group row">
                            <label for="lastname" class="col-md-3 col-form-label text-md-right">{{ __('Uzvārds *') }}</label>
     ...
     <div class="form-group row">
        <label for="subject" class="col-md-3 col-form-label text-md-right">{{__('Pasniegtais priekšmets') }}</label>
            <div class="col-md-6">
        ...
        @if(Auth::user()->role == 'skolotajs')
     <div class="form-group row">
        <label for="education" class="col-md-3 col-form-label text-md-right">{{__('Izglītība') }}</label>
            <div class="col-md-6">
     ...
     <div class="form-group row">
        <label for="school" class="col-md-3 col-form-label text-md-right">{{__('Mācību iestāde') }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group row">
        <label for="age" class="col-md-3 col-form-label text-md-right">{{__('Vecums') }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group row">
        <label for="description" class="col-md-3 col-form-label text-md-right">{{__('Apraksts par Jums') }}</label>
            <div class="col-md-6">
